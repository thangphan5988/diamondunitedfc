/* AFF Cup 2026 hub — tin 24h + số liệu API-Football qua DUFC Worker */
...
function wcRenderNewsHub(data, append) {
  ...
  if (!hasHero && !items.length) {
    el.innerHTML = `<div class="wcEmpty">Chưa có tin AFF Cup 2026.</div>`;
    return;
  }
  ...
  const listHtml = items.length
    ? `<section class="wcNewsLatest">
        <h2 class="wcNewsSectionTitle">Tin mới AFF Cup 2026</h2>
...
function wcTeamOverviewHtml(team) {
  ...
  return `
    ...
    <div class="wcDetailSection">
      <div class="wcDetailMetaGrid">
        ${wcMetaItem("Mã đội", team.fifaCode)}
...
function wcTeamPlayersHtml(team) {
  ...
  return `
    <div class="wcDetailSection">
      ...
      <p class="wcDetailSource">Nguồn: <a href="${wcEscapeHtml(squad.source_url || "https://en.wikipedia.org/wiki/2026_ASEAN_Championship")}" target="_blank" rel="noopener noreferrer">Wikipedia</a> · Ảnh &amp; thông số từ Wikipedia / Wikidata</p>
    </div>`;
}
